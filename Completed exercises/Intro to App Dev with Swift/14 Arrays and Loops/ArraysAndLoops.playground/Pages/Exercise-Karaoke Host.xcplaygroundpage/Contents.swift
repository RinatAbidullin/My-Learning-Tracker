 ...
 */
var songs = [String]()
songs.append("Батарейка")
songs.append("Половинка")
songs.append("На заре")
/*:
 - callout(Exercise):
 ...
 */
let list = ["Полковнику никто не пишет", "Елочка", "Звезда по имени Солнце"]
songs += list
/*:
 - callout(Exercise):
 ...
 */
for song in songs {
    print("Сейчас будет играть песня: \(song)")
}
/*:
 - callout(Exercise):
