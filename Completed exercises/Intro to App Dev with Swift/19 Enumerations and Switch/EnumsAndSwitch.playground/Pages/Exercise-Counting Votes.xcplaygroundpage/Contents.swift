 ...
 */
var countOfBeachVotes = 0
var countOfChocolateFactoryVotes = 0
for tripDestinationVote in tripDestinationVotes {
    switch tripDestinationVote {
    case .beach:
        countOfBeachVotes += 1
    case .chocolateFactory:
        countOfChocolateFactoryVotes += 1
    }
}
if countOfBeachVotes > countOfChocolateFactoryVotes {
    print("Beach win")
} else if countOfBeachVotes < countOfChocolateFactoryVotes {
    print("Chocolate factory win")
} else {
    print("Draw")
}
/*:
 ...
 */
var countOfSalamanderVotes = 0
var countOfMarmotVotes = 0
for mascotVote in mascotVotes {
    switch mascotVote {
    case .salamander:
        countOfSalamanderVotes += 1
    case .marmot:
        countOfMarmotVotes += 1
    case .neither:
        continue
    }
}
if countOfSalamanderVotes > countOfMarmotVotes {
    print("Salamander win")
} else if countOfSalamanderVotes < countOfMarmotVotes {
    print("Marmot win")
} else {
    print("Draw")
}
