...
makeFavorite(categoryOfThing: "movie", favorite: "Mind Games")
...
"Hello, my name is Euna. \(makeFavorite(categoryOfThing: "food", favorite: "cheese")). \(makeFavorite(categoryOfThing: "movie", favorite: "Mind Games"))"
