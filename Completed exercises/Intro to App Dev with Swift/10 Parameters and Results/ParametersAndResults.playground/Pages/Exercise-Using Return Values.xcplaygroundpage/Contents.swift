...
let count = impossibleBeliefsCount(pigsFlying: 5, frogsBecomingPrinces: 3, multipleLightningStrikes: 8)
impossibleThingsPhrase(numberOfImpossibleThings: count, meal: "coffe")
