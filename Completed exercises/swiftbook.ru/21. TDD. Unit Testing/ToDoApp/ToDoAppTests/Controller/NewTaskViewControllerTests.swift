...
class NewTaskViewControllerTests: XCTestCase {
    ...
    func testGeocoderFetchesCorrectCoordinate() {
        ...
        let addressString = "Екатеринбург"
        ...
        geocoder.geocodeAddressString(addressString) { (placemarks, error) in
            ...
            XCTAssertEqual(latitude, 56.8487949)
            XCTAssertEqual(longitude, 60.6172045)
    ...
    func testSaveDismissesNewTaskViewController() {
        ...
        mockNewTaskViewController.addressTextField.text = "Екатеринбург"
        mockNewTaskViewController.dateTextField = UITextField()
        mockNewTaskViewController.dateTextField.text = "01.03.20"
